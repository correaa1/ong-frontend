    ...
    return (
        <Container minW='100%'>
            <TableContainer rounded='lg' sx={{
                ...
                <Table variant="striped" bg='gray.300' w='full'>
                    <Thead>
                        <Tr position='sticky' top={0} h='4.5rem' zIndex={1} bg='gray.500'  my=".8rem">
                    ...
                    <Tbody>
                        {sortedData.map((item, index) => (
                            <Tr key={index} onClick={() => onRowClick(item)} cursor="pointer">
